    ...
    $.OrionCart = function (opts) {
        ...
        function renderItems (items) {
            ...
            items.forEach(function (item, index, array) {
                ...
                // newBlock += '<div class="cart-item-info--name"><span class="name">'+item.name+'</span><span class="price">R$'+priceFormatted+'</span></div><div class="cart-item-info--price--buttons">';
