!function(){try{var e="https://drogariaglobo-middleware.herokuapp.com";let i={init:()=>{i.verifyToken(),i.verifyStatusDiscount(),i.getProductData(),i.pbmAllEvents(),i.applyMaskCPF(),i.closeAcceptModal(),i.applySelectedDiscount()},windowOnload:()=>{},ajaxStop:()=>{},data:null,pbmSpecData:null,routes:{prodData:"/api/catalog_system/pub/products/search/?fq=productId:",getToken:"https://api-mng.interplayers.com.br/gip-scs-svc/token",getListDiscounts:e+"/middleware/v1/prices-discounts",getCart:e+"/middleware/v1/update-cart",changePrice:e+"/middleware/v1/change-price-vtex"},verifyToken:async()=>{if($.cookie("dagInterplayersToken")){var t=$.cookie("dagInterplayersToken_expiration"),t=new Date(t);if(new Date<t)return void console.log("Token ativo.");$.removeCookie("dagInterplayersToken"),$.removeCookie("dagInterplayersToken_expiration")}t=await i.requestGenerateToken();if(t&&t.access_token){console.log("Novo token");let e=i.dateConverterToBrazilTimezone(!0);$.cookie("dagInterplayersToken",t.access_token,{expires:1}),$.cookie("dagInterplayersToken_expiration",e.toString(),{expires:1})}},verifyStatusDiscount:()=>{orionLocalStorage.getItem("dagCurrentDiscountActivatedSeted")?$(".pbm-discount-activated").addClass("discount-activated-on"):$(".pbm-standard-discount").addClass("standard-discount-on")},getProductData:async()=>{var e=await i.requestProductData();i.data=e[0],i.checkingIfHasPBM(i.data)},checkingIfHasPBM:e=>{e.productPbmOn&&e.productPbmOn&&"S"==e.productPbmOn&&(i.pbmSpecData={requestHolderId:e.requestHolderId[0],productPbmOn:e.productPbmOn[0],requestCoupon:e.requestCoupon[0],eanCombos:e.eanCombos[0],industryName:e.industryName[0],todayTableId:e.todayTableId[0],formattedPrice:e.formattedPrice[0],standardPrice:e.standardPrice[0]},$(".pbm-prod-price").text(i.pbmSpecData.standardPrice),$(".pbm-prod-discount-activated-text").text(i.pbmSpecData.industryName))},pbmAllEvents:()=>{let a=$(".pbm-document-field");$(".pbm-standard-discount").on("click",function(e){e.preventDefault(),i.pbmFront.showDefaultDiscount.hide(),i.pbmFront.showFieldCPF.show()}),$(".pbm-list-discounts-finded--remove").on("click",function(e){e.preventDefault(),i.pbmFront.showListDiscountsPrices.hide(),i.pbmFront.showDefaultDiscount.show()}),$("#pbm-prod-btn-remove-discount").on("click",function(e){e.preventDefault(),i.getCurrentProductPBM()?(i.pbmFront.showDiscountActivated.hide(),i.pbmFront.showLoading.show(),vtexjs.checkout.getOrderForm().then(function(e){let t=i.getProductIndexOrderForm(e.items);if("false"!=t)return e={index:t="zero"==t?0:t,quantity:0},vtexjs.checkout.updateItems([e],null,!1)}).done(function(e){i.clearDiscountAndCart(),setTimeout(function(){i.pbmFront.showLoading.hide(),i.pbmFront.showDefaultDiscount.show(),setTimeout(function(){window.location.reload()},500)},1e3)})):alert("Nenhum produto do PBM selecionado.")}),$("#pbm-prod-btn-cpf-add").on("click",function(e){e.preventDefault();let n=$("#pbm-prod-input-cpf").val();if(n.length<14)alert("CPF Incompleto.");else{a.removeClass("document-field-on"),i.pbmFront.showLoading.show(),n=n.replace(/[^\w\s]/g,""),window.orionLocalStorage.setItem("dagUserCPF",n,120);let e=i.data.items[0].sellers[0].commertialOffer.ListPrice,t=i.data.items[0].sellers[0].commertialOffer.Price,o={id:i.data.productId,packId:0,EAN:i.data.items[0].ean,requestedQuantity:1,pricesOriginal:{listPrice:e,netPrice:t},pricesFormatted:{listPrice:e.toString().replace(".",""),netPrice:t.toString().replace(".","")},discountType:"L"};window.orionLocalStorage.setItem("dagCurrentProductPBM",JSON.stringify(o),120),i.consultDiscountIntegration(n,o)}})},consultDiscountIntegration:async(e,t)=>{var e={cpf:e,product:t},t=await i.requestListDiscounts(e);"H119"==t.responseCode?(i.pbmFront.showLoading.hide(),e={url:t.urlTerms,text:t.message},i.showAcceptTermsModal(e)):"Q294"==t.responseCode?(i.pbmFront.showLoading.hide(),localStorage.setItem("dagCentralNumber",t.centralNumber),swal({title:"Termos aceitos!",text:"Agora o proximo passo é realizar seu cadastro, redirecionando para o formulario.",icon:"success",closeOnClickOutside:!1}).then(()=>{window.location.pathname="/cadastro-programa"})):"H127"==t.responseCode?(i.pbmFront.showLoading.hide(),swal({title:"Atenção",text:t.informativeText,icon:"warning",closeOnClickOutside:!1}).then(()=>{window.location.reload()})):"N000"==t.responseCode?(i.renderListDiscountsPrices(t.listPrices),i.pbmFront.showLoading.hide(),i.pbmFront.showListDiscountsPrices.show()):t&&"401"==t.responseCode&&(i.pbmFront.showLoading.hide(),$.removeCookie("dagInterplayersToken"),$.removeCookie("dagInterplayersToken_expiration"),i.verifyToken(),swal({title:"Atenção",text:"Navegação expirada. Gerando um novo token.",icon:"warning",closeOnClickOutside:!1}).then(()=>{window.location.reload()}))},renderListDiscountsPrices:e=>{let t=$(".pbm-list-discounts-prices-wrapper"),o="";e.forEach(function(e){e=`
